...
export const TROPHIES = [
  ...
  { id: 'boffline', medal: '🎟️', title: 'Boffington\'s Travelcard', desc: 'As Finn Boffington or Flynn Boddington: ride the Mystic Line to all THREE original stations \u2014 the cave, the lakeshore and the copse \u2014 in one run.' },
  ...
  { id: 'nellyfive', medal: '📉', title: 'Told You So', desc: 'As Negative Nelly: take THREE negative whirlpool spins IN A ROW in one run.' },
  ...
  { id: 'mcdcoffee', medal: '☕', title: 'The Usual', desc: 'As McDonovan: take the coffee cart\u2019s +30 health. A private eye runs on it.' },
  ...
  { id: 'fedora180', medal: '🎯', title: 'One Hundred And Eighty', desc: 'As Triangle the Fedora: finish on EXACTLY 180, having used no rocket all run.' },
  ...
  { id: 'meetmaker', medal: '🧁', title: 'Meet Your Maker', desc: 'As Neptune\u2019s Muffin: collect a Neptune\u2019s Raisin AND touch the cottage stove in the same run. The stove will set you alight; that is the price of meeting the god who baked you.' },
  { id: 'badrequest', medal: '📟', title: '400 Bad Request', desc: 'As Error #45: finish a run on 400 or more \u2014 the same bar the rest of the family answers to.' },
